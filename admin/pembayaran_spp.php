        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Tabel Pembayaran</h4>
          ...
          <div class="row">
            <div class="col-12">
              ...
              if ($result && mysqli_num_rows($result) > 0) {
                  ...
                  echo "<center>";
                  echo "<b>Halo, $nama_siswa! Anda terakhir membayar pada bulan $bulan_spp, tanggal $tanggal_spp dengan tahun ajaran $tahun_ajaran.</b>";
                  echo "</center>";
                  echo '</div>';
              } else {
                  ...
                  <table id="zero_config1" class="table table-striped table-bordered">
                    ...
                    <tbody class="customtable">
                      ...
                      <tr>
                        ...
                        <td>
                          <?php if ($tagihan == "") { ?>
                            <a class="btn btn-sm btn-primary" href="" data-bs-toggle="modal" data-bs-target="#bayarModal<?php echo $rt['id_tagihan']; ?>"><i class="mdi mdi-credit-card"></i> Bayar Sekarang</a>
