        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Tabel Kelas</h4>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="card-title" style="display: grid; justify-content: end;">
                    <a class="btn btn-sm btn-primary" href="" data-bs-toggle="modal" data-bs-target="#kelasModal"><i class="mdi mdi-plus"></i> Tambah Data</a>
                  </div>
                    ...
                    >
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-sm btn-warning" href="" data-bs-toggle="modal" data-bs-target="#kelaseditModal<?php echo $row['id_kelas']; ?>"><i class="mdi mdi-pencil"></i></a>
                            <a class="btn btn-sm btn-danger" href="hapuskelas.php?id=<?php echo $row['id_kelas']; ?>"><i class="mdi mdi-delete"></i></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
              ...
              ?>
              <div class="modal fade" id="kelaseditModal<?php echo $rk['id_kelas']; ?>" tabindex="-1" aria-labelledby="kelasModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="kelasModalLabel">Edit Kelas</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      <form method="POST" action="update_kelas.php">
                        <input type="hidden" name="idk" value="<?php echo $rk['id_kelas']; ?>">
                        <div class="mb-3">
                          <label for="namaKelas" class="form-label">Nama Kelas</label>
                          <input type="text" class="form-control" id="namaKelas" name="namaKelas" value="<?php echo $rk['nama_kelas']; ?>" placeholder="Masukkan Nama Kelas">
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                          <button type="submit" class="btn btn-primary">Simpan</button>
